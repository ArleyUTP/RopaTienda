 ...
 * @author user
 */
public class coloas extends javax.swing.JFrame {

    /**
     * Creates new form coloas
     */
    public coloas() {
        initComponents();
    }
    ...
    private void btn_elegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_elegirActionPerformed
        ...
        Color selectColor = ColorPicker.showDialog("Escoja su color", Color.WHITE);
        if (selectColor != null) {
            colorMostrar.setBackground(selectColor);
            // Obtener el valor del color en formato hexadecimal
            String hexColor = String.format("#%02x%02x%02x", selectColor.getRed(), selectColor.getGreen(), selectColor.getBlue());

            // Actualizar el JTextField con el valor del color
            txt.setText(hexColor);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(coloas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
