...
public class Menu extends javax.swing.JPanel {
    ...
    private void initMenu() {
        addMenu("Menu Principal", "1", 0);
        addMenu("Mantenimiento Usuarios", "2", 1);
        addMenu("Mantenimiento Productos", "3", 2);
        addMenu("Orden", "4", 3);
        menu.repaint();
        menu.revalidate();
        setSelectedMenu(0);
    ...
    private void addMenu(String menuName, String icon, int index) {
        drawer.MenuButton m = new MenuButton();
        m.setIcoName(icon);
        m.setIcon(new ImageIcon(getClass().getResource("")));
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        g2.setColor(drawer.SystemTheme.mainColor);
    ...
    private void clearSelected() {
        for (Component com : menu.getComponents()) {
            if (com instanceof MenuButton) {
                ...
                c.setEffectColor(Color.decode("#39E079"));
                if (!c.getIcoName().contains("_s")) {
//                    c.setIcon(new ImageIcon(getClass().getResource("")));
                }
            }
        }
    }
