...
import Vista_Orden.Vistar_Ordenes;
                    ...
                    public void selected(MenuAction action, int index, int subIndex) {
                        if (index == 0) {
                            ...
                            switch (subIndex) {
                                ...
                                case 2 -> {
                                    if (contenedor != null) {
                                        Vistar_Ordenes vistar_Ordenes = new Vistar_Ordenes();
                                        contenedor.setLayout(new BorderLayout());
                                        contenedor.removeAll();
                                        contenedor.add(vistar_Ordenes, BorderLayout.CENTER);
                                        contenedor.revalidate();
                                        contenedor.repaint();
                                    }
                                }
