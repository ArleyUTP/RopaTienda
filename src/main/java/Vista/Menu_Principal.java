...
public class Menu_Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(782, 631));
...
// Establece layout si aún no lo hiciste
        jPanel1.setLayout(new BorderLayout());

// Agrega el panel 'Orden'
        jPanel1.add(orden, BorderLayout.CENTER); // Usa la posición que prefieras

// Asegúrate de actualizar la vista
        jPanel1.revalidate();
        jPanel1.repaint();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jPanel1.setLayout(new BorderLayout());
        jPanel1.add(man, BorderLayout.CENTER);
        jPanel1.revalidate();
        jPanel1.repaint();
